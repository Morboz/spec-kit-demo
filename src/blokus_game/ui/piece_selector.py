...
class PieceSelector(ttk.Frame):
    ...
    def __init__(
        ...
        parent: tk.Widget,
        player: Player,
        on_piece_selected: Callable[[str], None] | None = None,
    ) -> None:
        """
    ...
    def _update_piece_list(self) -> None:
        ...
        for piece in unplaced_pieces:
            ...
            name_label = ttk.Label(
                info_frame, text=piece.name, font=("Arial", 10, "bold")
            )
    ...
    def _draw_piece_on_canvas(self, canvas: tk.Canvas, piece_name: str) -> None:
        """
